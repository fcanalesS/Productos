$(document).ready(function () {
    $.get("/tree", function (data) {
        ...
        for (i = 0; i < data.length; i++) {
            ...
            table = table + "<thead>";
            table = table + "<tr><th class='text-center'>" + data[i].text + "</th><th></th><th></th></tr>";
            table = table + "</thead>";
            ...
            for (j = 0; j < nodes.length; j++) {
                table += "<tr><td></td><td class='text-center'>" + nodes[j].text + "</td><td class='text-center'>" +
                    "<input style='margin-right: 5em' type='checkbox' name='chkFile-" + j + "' class='' value='1'>" +
        ...
        // table = table + "<tr><th></th><th></th><th class='text-center'>Correcto / Incorrecto</th>";
        // for (i = 0; i < data.length; i++) {
        ...
        //     for (j = 0; j < nodes.length; j++) {
        //         console.log(nodes[j]);
        //         table = table + "<tr id='files-" + j + "'>";
        //         table = table + "<td> </td>"
        //         table = table + "<td>" + nodes[j].text + "</td>";
        //         table = table + "<td class='text-center'> " +
        //             "<input style='margin-right: 5em;' type='radio' name='radio-" + j + "' id='radio" + j + "' value='si' >" +
        //             "<input type='radio' name='radio-" + j + "' id='radio" + j + "' value='no' > </td>"
        //
        //
        //     }
        //     table = table + "</tr>";
